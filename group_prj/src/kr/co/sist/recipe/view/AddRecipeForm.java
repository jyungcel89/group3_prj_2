...
public class AddRecipeForm extends JDialog {
	...
	public AddRecipeForm(String menuName){
		...
		setLayout(null);
		// 백그라운드
		JLabel jlImg = new JLabel(new ImageIcon(System.getProperty("user.dir")+"/src/kr/co/sist/recipe/img/addrcpBack.png"));
		setContentPane(jlImg);
		Font defaultFont =new Font("맑은 고딕", Font.BOLD, 14);
	
//		region 레시피 이미지 추가하는 라벨 및 이미지 아이콘
		imgIcon=new ImageIcon(System.getProperty("user.dir")+"/src/kr/co/sist/recipe/img/default.jpg");
		lblImg = new JLabel(imgIcon);
		lblImg.setBounds(80,50,260,200);
		add(lblImg);
		
		//기본이미지
		JLabel img = new JLabel(new ImageIcon(System.getProperty("user.dir")+"/src/kr/co/sist/recipe/img/default.jpg"));
